...
export const Bookmark = [
  {
    ...
    description:
      'Improve your front-end coding skills by building real projects. Solve real-world HTML, CSS and JavaScript challenges whilst working with professional designs.',
